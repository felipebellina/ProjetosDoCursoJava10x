...
import br.com.movieflix.movieflix.exeption.UsernameOrPasswordInvalidException;
...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> login(@RequestBody LoginRequest request) {
        try {
            UsernamePasswordAuthenticationToken userAndPass = new UsernamePasswordAuthenticationToken(request.email(), request);
            ...
            throw new UsernameOrPasswordInvalidException("Usário ou senha inválido.");
        }
    }
